...
const BeMerchant = () => {
  return (
    <div className=" bg-[url('assets/be-a-merchant-bg.png')] bg-no-repeat border-2 rounded-4xl my-24 py-16 bg-[#03373D] overflow-hidden px-4 w-[96%] mx-auto">
      <div className="hero-content flex-col lg:flex-row-reverse items-center gap-10">
        ...
        <div className="mt-11 md:mt-0 text-center lg:text-left ">
          ...
          <div className="flex flex-col sm:flex-row gap-4 sm:gap-6 justify-center lg:justify-start">
            ...
            <button className="text-lime-300 border-2 border-lime-300 py-2 px-6 hover:bg-lime-300 hover:text-black font-semibold rounded-4xl">Earn with ZapShift Courier</button>
          </div>
        </div>
      </div>
    </div>
